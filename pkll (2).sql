...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Jan 2026 pada 13.45
...
(51, '::1', 'admincb', NULL, '2026-01-08 12:06:53', 0),
(52, '::1', 'adminsmkcb', NULL, '2026-01-08 12:07:09', 0),
(53, '::1', 'adminsmkcb@gmail.com', 1, '2026-01-08 12:07:24', 1);
...
(1, 'Admin Utama', 'admin@izin.sch.id', '$2y$10$PuPXuv7rfW5sLzlAiNJOJuU9YfdtcwuZ3evxIxdWEpQJVgxv9tJlS', 'admin', '2025-12-30 17:05:08', '2026-01-08 18:35:58'),
...
(4, 'reyhandwiandika', 'drehan566@gmail.com', '$2y$10$uDH9ZKkztm3bEJSOP6rF9.nIrAeTCpgTYXdIT9sbwFuOe4YL1LjGO', 'guru', '2026-01-08 12:23:13', NULL);
...
--
ALTER TABLE `wali_kelas`
  ADD CONSTRAINT `wali_kelas_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `userizin` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `wali_kelas_ibfk_2` FOREIGN KEY (`id_kelas`) REFERENCES `tb_kelas` (`id_kelas`) ON DELETE CASCADE;
COMMIT;
