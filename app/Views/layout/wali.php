...
<head>
    <meta charset="UTF-8">
    <title><?= $title ?? 'E-Presensi wali' ?></title>
...
<div class="d-flex">
    <aside class="sidebar shadow-lg">
        <div class="sidebar-header">
            <a href="<?= site_url('wali/dashboard') ?>" class="sidebar-brand">
        ...
        <nav class="nav-custom mt-2">
            <a href="<?= site_url('wali/dashboard') ?>" class="<?= url_is('wali/dashboard*') ? 'active' : '' ?>">
                <i class="bi bi-grid-1x2-fill"></i> Dashboard
            </a>
            <a href="<?= site_url('wali/siswa') ?>" class="<?= url_is('wali/siswa*') ? 'active' : '' ?>">
                <i class="bi bi-people-fill"></i> Data Siswa
            </a>
            <a href="<?= site_url('wali/izin') ?>" class="<?= url_is('wali/izin*') ? 'active' : '' ?>">
            ...
            <a href="<?= site_url('wali/settings') ?>" class="<?= url_is('wali/settings*') ? 'active' : '' ?>">
    ...
    <main>
        <header class="top-navbar d-flex justify-content-between align-items-center">
            ...
            <div class="d-none d-md-block">
                <span class="text-muted small fw-medium">Panel waliistrasi &bull; <?= date('d M Y') ?></span>
            </div>
            
            <div class="d-flex align-items-center">
                <div class="text-end me-3 d-none d-sm-block">
                    <p class="mb-0 small fw-bold text-dark">waliistrator</p>
                    <p class="mb-0 text-muted" style="font-size: 0.7rem;">Superuser Access</p>
                </div>
                <div class="avatar-box">
                    <img src="https://ui-avatars.com/api/?name=wali&background=4361ee&color=fff&bold=true" class="rounded-circle border border-2 border-white shadow-sm" width="40" height="40" alt="Avatar">
                </div>
            </div>
        </header>
