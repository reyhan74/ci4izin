...
<div class="container-fluid py-4">
    <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex" style="gap: 10px;">
            ...
            <a href="/guru/siswa/create" class="btn btn-primary shadow-sm px-4 rounded-pill hover-lift">
        ...
        <div class="card-body p-3">
            <form action="" method="get" class="row align-items-end">
                ...
                <div class="col-md-4">
                    ...
                    <a href="/guru/siswa" class="btn btn-sm btn-light px-4 rounded-pill border">
                            ...
                            <tr>
                                ...
                                <td class="text-center pr-4 align-middle">
                                    <div class="d-flex justify-content-center" style="gap: 8px;">
                                        <a href="/guru/siswa/show/<?= $s['id_siswa']; ?>" class="btn-action btn-view" title="Detail"><i class="fas fa-eye"></i></a>
                                        <!-- <a href="/guru/siswa/edit/<?= $s['id_siswa']; ?>" class="btn-action btn-edit" title="Edit"><i class="fas fa-pencil-alt"></i></a> -->
                                        <!-- <button type="button" class="btn-action btn-delete" onclick="confirmDelete('/guru/siswa/delete/<?= $s['id_siswa']; ?>', '<?= addslashes($s['nama_siswa']); ?>')">
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
            ...
            <form action="/guru/siswa/import" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="modal-body p-4">
                    <div class="text-center mb-4 p-3 border rounded bg-light shadow-sm">
                        ...
                        <a href="/guru/siswa/downloadTemplate" class="btn btn-outline-success btn-sm rounded-pill px-4">
