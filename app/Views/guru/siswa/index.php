...
<div class="container-fluid py-4">
    <div class="d-sm-flex align-items-center justify-content-between mb-4 animate__animated animate__fadeIn">
        ...
        <!-- <div class="d-flex" style="gap: 10px;">
            ...
            <a href="<?= base_url('guru/siswa/create'); ?>" class="btn btn-primary shadow-sm px-4 rounded-pill hover-lift">
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center" style="gap: 5px;">
                                        <a href="<?= base_url('guru/siswa/show/'.$s['id_siswa']); ?>" class="btn-action btn-view" title="Detail"><i class="fas fa-eye"></i></a>
                                        <!-- <a href="<?= base_url('guru/siswa/edit/'.$s['id_siswa']); ?>" class="btn-action btn-edit" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                        <button type="button" class="btn-action btn-delete" onclick="confirmDelete('<?= base_url('guru/siswa/delete/'.$s['id_siswa']); ?>', '<?= addslashes($s['nama_siswa']); ?>')">
...
<!-- <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
            ...
            <form id="formImport" action="<?= base_url('guru/siswa/import'); ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="modal-body p-4">
                    <div class="text-center mb-4 p-3 border rounded bg-light">
                        ...
                        <a href="<?= base_url('guru/siswa/downloadTemplate'); ?>" class="btn btn-outline-success btn-sm rounded-pill px-4">
