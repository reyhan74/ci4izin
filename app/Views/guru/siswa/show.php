...
<div class="container-fluid py-4">
    <div class="row mb-3">
        <div class="col-12">
            <a href="/guru/siswa" class="btn btn-sm btn-secondary shadow-sm">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm mb-4 border-0 rounded-lg text-center p-4">
                ...
                <!-- <div class="d-flex justify-content-center mb-4" style="gap: 10px;">
                    <a href="/guru/siswa/edit/<?= $siswa['id_siswa']; ?>" class="btn btn-warning btn-sm px-3 text-white rounded-pill shadow-sm">
